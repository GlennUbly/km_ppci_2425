...
if show == 'Map of potential sites' :
    ...
    st.write("The sites considered in addition to the 2 London sites and "+
             "the current EKUHFT site at the William Harvey Hospital are the six in the area with "+
...
if show == 'Travel times by LSOA' :
    ...
    st.write('The current minimum travel times are distributed geographically as '+
              'follows, assuming patients travelling the shortlest journey to one of the 2 London '+
              'sites or the EKUHFT at the William Harvey Hospital site shown')
...
if show == 'Travel times compared to national median' :
    ...
    st.write('We see only the areas close to the EKUHFT site at the William Harvey Hospital '+
             'with travel times less than the national median')
