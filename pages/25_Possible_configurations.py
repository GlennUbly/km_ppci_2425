...
# 13/10/2025 GU
# Page 2 for maps and charts for possible new site configurations
...
st.markdown("#### This map shows the expected travel times in the case "+
            "that additional site(s) are available to patients, on the "+
...
st.markdown("#### The summarised results for the configurations are shown "+
            "here, looking at the 6 single sites, and the 15 options with "+
            "2 additional sites ")
